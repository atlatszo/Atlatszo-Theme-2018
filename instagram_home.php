<section class="n100 section-instagram">
	...
	<?php echo do_shortcode('[instagram-feed num='.$instagram_feedek_szama.' cols=4 imagepadding=0 showbutton=false showfollow=false]'); ?>
